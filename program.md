...
**七牛云·对象存储** 实际上具有公共读权限的对象存储空间也可以看成一个静态文件服务器，七牛云的对象存储空间还可以设置空间默认主页和404页面，功能完备。
...
如果你有一个已备案的域名，再去领一个[免费CDN加速](https://portal.qiniu.com/signup?code=1hfwb75ib2jbm)，完美。
...
还等啥，去申请一个[免费SSL](https://portal.qiniu.com/signup?code=1hfwb75ib2jbm)证书吧。
